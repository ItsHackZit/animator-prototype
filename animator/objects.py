...
class Path:
    ...
    @escape
    def __init__(self, init_point: core.Point, **flags):
...
class Shape:
    ...
    @escape
    def __init__(self, origin: core.Point, **flags):
        self.origin = origin
        self.fill = flags['fill']
...
class Rectangle(Shape):
    ...
    def __init__(self, frame: core.Rect, **flags):
