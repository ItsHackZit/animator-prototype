...
class _escape(types.ModuleType):
    ...
    class _Runner(ast.NodeTransformer):
    ...
    def __call__(self, victim):
        ...
        if isinstance(victim, basestring):
            ...
            try:
                ...
                tree = self._Runner().visit(ast.parse(source))
            ...
            # Allow chaining of escape import calls
...
__doc__ = ''
sys.modules[__name__] = _escape('escape', __doc__)
